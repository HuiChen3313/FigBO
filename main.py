...
def main(cfg: DictConfig) -> None:
    ...
    print(f"cfg.benchmark.bounds: {cfg.benchmark.bounds}")
    ...
    # if cfg.acq.acq_func == "FigBO":
    #     acq_func_kwargs["bounds"] = bounds  #FigBO
    ...
    print(f"Bounds passed to GenerationStep: {bounds}")
    bo_step = GenerationStep(
        ...
        model_kwargs={  # Kwargs to pass to `BoTorchModel.__init__`
            ...
            "botorch_acqf_class": acq_func, #use acq
    ...
    for i in range(total_batches):
        ...
        if cfg.benchmark.get('synthetic', True):
            ...
            results_df['True Eval'] = true_vals   #only for synthetic function
            if current_count > num_init:
