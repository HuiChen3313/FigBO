...
from botorch.models import (
    # FixedNoiseGP, #This fucntion is not available in botorch version 0.12.0 
    SingleTaskGP,
...
MODELS = {
    # 'FixedNoiseGP': FixedNoiseGP, #This fucntion is not available in botorch version 0.12.0 
